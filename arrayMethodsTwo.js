...
let divideNum = numbers.forEach((el)=> console.log(el/2))
...
let endsInI = cities.filter((place) => place.endsWith("i"))
...
fruits.forEach((fruit, index) => {
  ...
  return console.log(`The fruit with index ${index} is neither an apple or an orange`)
}})

// fruits.forEach((elem, index) => elem.color==='red' ? console.log(`The fruit with index ${index} is an apple`) : elem.color==='orange' ? console.log(`The fruit with index ${index} is an orange`) : console.log(`The fruit with index ${index} is neither apple or orange`))
